...
| 보스 | 액트 | 메모 |
|---|---|---|
| Phase Spider Matriarch | 1 | 거미줄 지형은 불로 태울 것. 알집 먼저 |
| **Grym** | 1 | **정면 싸움 금지.** 용암 위에 세워 **Superheated**(타격 취약) → **레버를 쏴서 망치 내려찍기.** [12-2](#12-2-adamantine-forge-아다만틴-용광로) ✔ |
| Nere | 1 | 낙석 압사 유도 가능. 시간제한 있음 |
| Ketheric Thorm | 2 | 1페이즈는 **영혼 연결된 적** 먼저. 광휘 피해 특효 |
| Myrkul | 2 | 소환물이 계속 나옴. Radiance of the Dawn + Fireball로 잡몹 우선 |
| Cazador | 3 | 의식 룬 위에 서지 말 것. **Counterspell 대기 필수** |
| Orin | 3 | 변신 + 은신 반복. Faerie Fire / Light로 은신 차단 |
| Gortash | 3 | 바닥 함정 먼저 파괴. Steel Watcher 유인해 분리 |
| **Raphael** | 3 | **Soul Pillar 4개 먼저 파괴**해야 본체에 피해가 들어감 |
| Ansur | 3 | **투구만 원하면 싸우지 않아도 됨.** [12-3](#12-3-helm-of-balduran-발두란의-투구) ✔ |
| Netherbrain | 3 | 이동속도 확보 필수. 본체보다 통로 정리 먼저 |
